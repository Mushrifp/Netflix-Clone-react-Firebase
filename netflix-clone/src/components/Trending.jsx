    ...
    <>
      ...
      <div className="relative">
        ...
        >
          <TrendingCard
            numberImage={one}
            posterPath={`${endpoints.image}${movie[0]?.poster_path}`}
          />
          <TrendingCard
            numberImage={two}
            posterPath={`${endpoints.image}${movie[1]?.poster_path}`}
          />
          <TrendingCard
            numberImage={three}
            posterPath={`${endpoints.image}${movie[2]?.poster_path}`}
          />
          <TrendingCard
            numberImage={four}
            posterPath={`${endpoints.image}${movie[3]?.poster_path}`}
          />
          <TrendingCard
            numberImage={five}
            posterPath={`${endpoints.image}${movie[4]?.poster_path}`}
          />
          <TrendingCard
            numberImage={six}
            posterPath={`${endpoints.image}${movie[5]?.poster_path}`}
          />
          <TrendingCard
            numberImage={seven}
            posterPath={`${endpoints.image}${movie[6]?.poster_path}`}
          />
          <TrendingCard
            numberImage={eight}
            posterPath={`${endpoints.image}${movie[7]?.poster_path}`}
          />
          <TrendingCard
            numberImage={nine}
            posterPath={`${endpoints.image}${movie[8]?.poster_path}`}
          />
          <TrendingCard
            numberImage={ten}
            posterPath={`${endpoints.image}${movie[9]?.poster_path}`}
          />
        </div>
